...
- Multiple action execution methods (`json_post`, `bulksms`, `mail`, `exec`)
- Built-in authentication (bearer tokens and signed URLs) for the HTTP API
...
* `exec` - run a local binary/script
